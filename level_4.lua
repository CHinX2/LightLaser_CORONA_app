...
function scene:show( event ) 
    ...
    elseif ( phase == "did" ) then 
        ...
        --------------------------  
        local mirrorSet = {
           { -100, -60, 90,"images/wall.png", 20, 150 },
        }
    ...
    -- Static mirror
        ...
        mirror_d2.x = display.contentCenterX + 75
        mirror_d2.y = display.contentCenterY + 60
        mirror_d2.rotation = 0
        ...
        paddle.x = display.contentCenterX - 40 
        ...
        turret.x = display.contentCenterX - 20
        turret.y = display.contentCenterY - 210
        turret.rotation = -150
      ...
      local start_b = display.newText( sceneGroup,"Start", turret.x, turret.y-3, native.systemFont, 16 )
