...
function scene:show( event ) 
    ...
    elseif ( phase == "did" ) then 
        ...
        --------------------------  
        local mirrorSet = {
           { 70, 100, 90,"images/wall.png", 20, 200 },
           { -100, -80, 90,"images/wall.png", 20, 200 },
        }
        ...
        mirror_d.x = display.contentCenterX +5
        mirror_d.y = display.contentCenterY - 100
        ...
        mirror_d2.x = display.contentCenterX - 50
        mirror_d2.y = display.contentCenterY + 10
        mirror_d2.rotation = 75
        
        ------------------------
        -- add paddle
        ------------------------
        local paddle = display.newImageRect( sceneGroup,"images/box.png", 58, 50 )
        paddle.x = display.contentCenterX - 100 
        paddle.y = display.contentCenterY + 150
        ...
        turret.x = display.contentCenterX - 105
        turret.y = display.contentCenterY - 200
        turret.rotation = 100
      ...
      local start_b = display.newText( sceneGroup,"Start", turret.x -5, turret.y, native.systemFont, 16 )
